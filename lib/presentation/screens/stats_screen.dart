...
import 'package:expensetracker/bloc/stats_bloc/stats_state.dart';
      ...
      listener: (context, state) {
        if (state is StatsDeleteSuccessState) {
          context.read<StatsBloc>().add(
            LoadStatsEvent(statsDate: currentSelectedDate),
          );
          showSnackBar(context, state.statsDeleteSuccessMessage);
        }
      },
                    ...
                    children: [
                      MonthPickerButton(
                        ...
                        onDateSelected: (selectedDate) {
                          ...
                          context.read<StatsBloc>().add(
                            StatsDateChangedEvent(selectedDate),
                          );
                        },
                      ),
